...
from lib.colocation_data_loader import make_data_loader
...
from lib.colocation_trainer import FinestContrastiveLossTrainer
...
def get_trainer(trainer):
  ...
  elif trainer == 'FinestContrastiveLossTrainer':
    return FinestContrastiveLossTrainer
  else:
...
if __name__ == "__main__":
  ...
  if config.resume_dir and not config.finetune_restart:
    ...
    for k in dconfig:
      if k not in ['resume_dir', 'finetune_restart'] and k in resume_config:
